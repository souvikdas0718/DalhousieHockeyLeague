...
//        standingSystem = standingsFactory.getStandingSystem();
...
//        draftPickSequence = new Team[32][7];
////        TeamMock teamMock = leagueMockFactory.createTeamMock();
////        ITeam team1 = teamMock.getTeamByName("Halifax Astros");
////        ITeam team2 = teamMock.getTeamByName("Torronto");
//        for(int i=0; i<32; i++){
//            for(int j=0; j<7; j++){
//                ITeam team = teamMock.getTeamByName("Team"+i+j);
//                draftPickSequence[i][j] =team;
//            }
//        }
//
...
//       Assertions.assertEquals("Team00",playerDraftPick[0][0].getTeamName());
//    }
//
//    @Test
...
//            }
//        }
//        Assertions.assertEquals(30,players.size());
//    }
//}
