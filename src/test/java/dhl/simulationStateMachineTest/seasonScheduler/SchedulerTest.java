...
//            System.out.println("Match Number "+ matchNumber + ": "+schedules.getTeamOne().getTeamName() + " VS "+schedules.getTeamTwo().getTeamName());
...
//        int matchNumber = 1;
        for (ISchedule schedules: scheduler.getFullSeasonSchedule()) {
//            System.out.println("Match Number "+ matchNumber + ": "+schedules.getTeamOne().getTeamName() + " VS "+schedules.getTeamTwo().getTeamName() + " date: " + schedules.getGameDate());
//            matchNumber = matchNumber + 1;
...
//        ILeagueObjectModel league = new LeagueObjectModel("Dalhousie Hockey League", conferences, playersList, coaches,  iGeneralManagers, gameConfig.getGameConfigMock());
//
//        ITeam team = new Team("Bruins", generalManager , headCoach , playersList);
//        ITeam teamS = new Team("Maple", generalManager , headCoach , playersList);
////        ITeam team = new Team("Oilers", generalManager , headCoach , playersList);
//        Scheduler scheduler = new Scheduler();
//        scheduler.playOffs(standings, league);
//        SchedulerTest test = new SchedulerTest();
//        test.playOffsTest();
//        scheduler.gameWinner(team);
//        scheduler.gameWinner(teamS);
////        System.out.println(scheduler.getPlayOffScheduleRound1().get(scheduler.getPlayOffScheduleRound1().size() - 1));
//        System.out.println(scheduler.getPlayOffScheduleRound1().get(scheduler.getPlayOffScheduleRound1().size() - 1).getTeamOne().getTeamName());
//        System.out.println(scheduler.getPlayOffScheduleRound1().get(scheduler.getPlayOffScheduleRound1().size() - 1).getTeamTwo().getTeamName());
